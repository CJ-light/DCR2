...
namespace DCR2
{
    public class CentroidGizmoAuthoring : MonoBehaviour
    {

        class Baker : Baker<CentroidGizmoAuthoring>
        {
            ...
            public override void Bake(CentroidGizmoAuthoring authoring)
            {
                var entity = GetEntity(TransformUsageFlags.Renderable);

                AddComponent(entity, new centroidGizmoComponent
                {
                });
            }
        }
    ...
    public struct centroidGizmoComponent : IComponentData
    {
    }
}
